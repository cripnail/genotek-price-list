...
mixin _$PriceState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Price> prices) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Price> prices)? loaded,
...
abstract class Loading implements PriceState {
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(final List<Price> prices) : _prices = prices;
  ...
  @override
  String toString() {
    return 'PriceState.loaded(prices: $prices)';
  }
...
abstract class Loaded implements PriceState {
  const factory Loaded(final List<Price> prices) = _$LoadedImpl;
...
class _$ErrorImpl implements Error {
  ...
  @override
  String toString() {
    return 'PriceState.error(message: $message)';
  }
...
abstract class Error implements PriceState {
